...
public class ReceptionistController {
    ...
    public ResponseEntity<Guest> viewGuestById(@PathVariable String guestId){
		ResponseEntity<Guest> viewGuestById = guestClient.viewGuestById(guestId);
		return viewGuestById;
	}
	
	@GetMapping("/viewall")
	@PreAuthorize("hasAuthority('ROLE_RECEPTIONIST')")
	public ResponseEntity<List<Guest>> viewAllGuest(){
		ResponseEntity<List<Guest>> viewAllGuest = guestClient.viewAllGuest();
		return viewAllGuest;
	}
}
